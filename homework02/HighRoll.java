...
public class HighRoll {
 ...
 public static void main(String args[]) {
  ...
  try {
   ...
   System.out.println("Invalid input! Need integers. Although you may have wanted to play the game, you played yourself.");
  }
  ...
  while (true) {
   ...
   try {
    ...
    } else if (1 < inputLine.length()) {
     System.out.println("Please only enter a 1 digit value: 1-5 to play or 'Q' to quit ");
